...
#define GPIO_KB_SCAN_1 (GPIO_Pin_9|GPIOB_GROUP_MASK)
#define GPIO_KB_SCAN_2 (GPIO_Pin_6|GPIOB_GROUP_MASK)
#define GPIO_KB_SCAN_3 (GPIO_Pin_3|GPIOB_GROUP_MASK)
#define GPIO_KB_SCAN_4 (GPIO_Pin_5|GPIOB_GROUP_MASK)

#define GPIO_KB_PULL_1 (GPIO_Pin_15|GPIOA_GROUP_MASK)
#define GPIO_KB_PULL_2 (GPIO_Pin_4|GPIOB_GROUP_MASK)
#define GPIO_KB_PULL_3 (GPIO_Pin_7|GPIOB_GROUP_MASK)
#define GPIO_KB_PULL_4 (GPIO_Pin_8|GPIOB_GROUP_MASK)
#define GPIO_BUTTON_TOP (GPIO_Pin_2|GPIOB_GROUP_MASK)
#define GPIO_WAKE_BAND (GPIO_Pin_12|GPIOB_GROUP_MASK)
#define GPIO_LED_PWR (GPIO_Pin_11|GPIOB_GROUP_MASK)
#define GPIO_RUMBLE_CTRL_L (GPIO_Pin_5|GPIOA_GROUP_MASK)
#define GPIO_RUMBLE_CTRL_R (GPIO_Pin_6|GPIOA_GROUP_MASK)

#define GPIO_BUTTON_LS (GPIO_Pin_13|GPIOC_GROUP_MASK)
#define GPIO_BUTTON_RS (GPIO_Pin_15|GPIOC_GROUP_MASK)

#define GPIO_BUTTON_LS_LEGACY (GPIO_Pin_8|GPIOA_GROUP_MASK)
#define GPIO_BUTTON_RS_LEGACY (GPIO_Pin_0|GPIOA_GROUP_MASK)

#define GPIO_BUTTON_LS_NGC (GPIO_Pin_5|GPIOB_GROUP_MASK)
#define GPIO_BUTTON_RS_NGC (GPIO_Pin_3|GPIOB_GROUP_MASK)
#define GPIO_BUTTON_ZL_NGC (GPIO_Pin_13|GPIOC_GROUP_MASK)
#define GPIO_BUTTON_R_NGC (GPIO_Pin_14|GPIOC_GROUP_MASK)
#define GPIO_BUTTON_ZR_NGC (GPIO_Pin_15|GPIOC_GROUP_MASK)



#define KB_SCAN_SETUP_TIME (8)
...
extern uint32_t sts_button,sts_button_raw;
extern uint32_t kb_pull[];
extern uint32_t kb_scan[];
