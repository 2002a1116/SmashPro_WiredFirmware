...
//#define hd_rumble_cvr_range_REDUCED (650)
//#define hd_rumble_cvr_range (540)
//RANGE IS FOR 1.5 VOLT,AS STOCK CONTROLLER USE AROUND 0.5V FOR UNDER 1.0 AMP
//SO WHEN WE HAVE AN OVER ALL BIGER RANGE(2V),WE USE BIGGER GAIN RESISTOR AND LOWER CVR FOR BIGGER OVERALL RANGE.
