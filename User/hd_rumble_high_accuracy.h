...
extern int32_t hd_rumble_cvr_range;
...
/*#define HD_RUMBLE_MAX_CVR_OFFSET (720)
#define hd_rumble_cvr_min (HD_RUMBLE_TIM_PERIOD_MID-HD_RUMBLE_MAX_CVR_OFFSET)
#define hd_rumble_cvr_max (HD_RUMBLE_TIM_PERIOD_MID+HD_RUMBLE_MAX_CVR_OFFSET)*/
